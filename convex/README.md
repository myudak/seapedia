...
For local development without a linked Convex deployment, the app uses seeded data through the same domain services. A real deployment should run `pnpm convex dev` and configure the variables from `.env.example`.
